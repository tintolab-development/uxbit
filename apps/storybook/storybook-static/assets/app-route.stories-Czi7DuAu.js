...
const i = [
  ...
  c = {
    ...
    argTypes: {
      ...
      gap: { control: 'text', description: '섹션 간 간격', table: { category: 'layout' } },
      padding: {
        control: 'text',
      ...
      paddingBlock: { control: 'text', description: '상하 패딩', table: { category: 'spacing' } },
      background: {
        control: 'color',
      ...
      radius: { control: 'text', description: '모서리 반경', table: { category: 'visual' } },
      shadow: { control: 'text', description: 'box-shadow', table: { category: 'visual' } },
      border: { control: 'text', description: 'border 전체 정의', table: { category: 'visual' } },
      heightMode: {
        control: { type: 'inline-radio' },
      ...
      return e(
        ...
        i.map((o) =>
          e(
            ...
            e('h2', { style: { fontSize: '2.25rem', margin: '0' } }, o.title),
            e('p', { style: { margin: '0', lineHeight: '1.6', color: '#CBD5F5' } }, o.description),
          ),
        ),
      );
    },
...
t.parameters = {
  ...
  render: args => {
    ...
    return <tinto-app-route {...rest as any} gap={gap as any}>
        {sectionCards.map(section => <tinto-section direction="column" gap="1.5rem" padding="3rem" radius="32px" background="rgba(15, 23, 42, 0.92)" color="#F8FAFC" shadow="0 25px 45px rgba(2, 6, 23, 0.55)">
            <p style={{
          textTransform: 'uppercase',
          fontSize: '0.75rem',
          letterSpacing: '0.3em',
...
const s = ['Playground'];
export { t as Playground, s as __namedExportsOrder, c as default };
