...
| `animationScale`     | `animation-scale`      | Optional scale multiplier applied during animation       | `number`                                                                                 | `undefined`  |
| `autoScaleThreshold` | `auto-scale-threshold` | Spin animation auto-scale trigger ratio (width/parent)   | `number`                                                                                 | `undefined`  |
| `autoScaleValue`     | `auto-scale-value`     | Scale to apply when auto-scale threshold is met          | `number`                                                                                 | `undefined`  |
...
| `scale`              | `scale`                | Base transform scale (1 = original size)                 | `number`                                                                                 | `undefined`  |
