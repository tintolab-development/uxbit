...
import { ButtonClickDetail, ButtonNativeType, ButtonSize, ButtonTextFamilyToken, ButtonTextSizeToken, ButtonTextWeightToken, ButtonToggleDetail, ButtonVariant } from "./components/button/button.types";
...
export { ButtonClickDetail, ButtonNativeType, ButtonSize, ButtonTextFamilyToken, ButtonTextSizeToken, ButtonTextWeightToken, ButtonToggleDetail, ButtonVariant } from "./components/button/button.types";
...
declare global {
    ...
    interface HTMLTintoButtonElement extends Components.TintoButton, HTMLStencilElement {
        addEventListener<K extends keyof HTMLTintoButtonElementEventMap>(type: K, listener: (this: HTMLTintoButtonElement, ev: TintoButtonCustomEvent<HTMLTintoButtonElementEventMap[K]>) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener<K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
        addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
        removeEventListener<K extends keyof HTMLTintoButtonElementEventMap>(type: K, listener: (this: HTMLTintoButtonElement, ev: TintoButtonCustomEvent<HTMLTintoButtonElementEventMap[K]>) => any, options?: boolean | EventListenerOptions): void;
