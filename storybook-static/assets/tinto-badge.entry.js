import { r as registerInstance, h, H as Host } from './index-3CssInHd.js';
...
const TintoBadge = class {
  ...
  render() {
    ...
    return h(
      Host,
      { key: 'dffdc85c077d9f1212ffcb90fbb5d8221737fa9a' },
      h(
        'span',
        { key: '5f429c3907fca16f83ffe27fd6de272ea0fc821a', class: classes },
        h('slot', { key: '89a96eb5cbdf853989ec8d5406e4549462ad47ba' }, 'Badge'),
      ),
    );
  }
};
